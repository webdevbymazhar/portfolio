...
const Projects = () => {
  return (
      ...
      <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",flexWrap:"wrap",gap:"30px"}}>
        <Card image={"blogitup.jpg"} title={"BlogItUp"} link={"https://github.com/webdevbymazhar/Blog-It-Up-"} text={"Blogitup is the full stack blog App made with MERN Stack."}/>
        <Card image={"dukaan.jpg"} title={"Dukaan.pk"} link={"https://github.com/webdevbymazhar/Dukaan.pk-"} text={"Ecommerce App made with ReactJs and fakestoreapi."}/>
        <Card image={"todoer.jpg"} title={"Todoer"} link={"https://github.com/webdevbymazhar/todoer"} text={"This is full stack Todo list app made with MERN Stack."}/>
